        ...
        <View style={styles.container}>
                ...
                <View style={styles.doctors}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("DoctorDetails")}>
                        <View style={styles.doctor}>
                            <Image style={styles.doctorImg} source={require("../assets/doctor.png")} />
            ...
            <View style={styles.footer}>
                <TouchableOpacity style={styles.footerButton}>
                    <Icon name="home-outline" size={25} color="#919191" onPress={() => navigation.navigate("Home")}/>
                ...
                <TouchableOpacity style={styles.footerButton} onPress={() => navigation.navigate("Schedule")}>
                    <Icon name="calendar-outline" size={25} color="#08da5f" />
                    <Text style={{ color: "#08da5f", fontSize: 10 }}>Schedule</Text>
                </TouchableOpacity>
